...
function isSettingsSectionKey(value: string | undefined): value is SettingsSectionKey {
  return value !== undefined && SETTINGS_SECTION_KEYS.includes(value as SettingsSectionKey)
}
...
function SettingsPage(): React.JSX.Element {
  ...
  const sectionMeta: Array<{
  ...
  }> = [
    {
      ...
      summary: `${settings.theme === 'dark' ? t('settings.themeDark') : settings.theme === 'light' ? t('settings.themeLight') : t('settings.themeSystem')} · ${settings.language.toUpperCase()}`
    },
    {
      key: 'system',
    ...
    },
    {
      ...
      summary: settings.autoCheckEnabled
        ? `${t('settings.backup.previewEnabled')} · ${settings.autoCheckIntervalMinutes} мин`
        : t('settings.backup.previewDisabled')
    },
    {
      key: 'checking',
      ...
      summary: `${settings.checkTimeoutMs / 1000} с · ${settings.checkAllMode === 'parallel' ? t('settings.checkAllModeParallel') : t('settings.checkAllModeSequential')}`
    },
    {
      key: 'backup',
        ...
        <Stack spacing={0.75}>
          {sectionMeta.map((item, index) => (
            <ButtonBase
              ...
              component="button"
              type="button"
              onClick={() => void navigate(`/settings/${item.key}`)}
              sx={{
                display: 'flex',
                width: '100%',
                ...
                gap: 1.5,
                p: { xs: 1.75, sm: 2 },
                borderRadius: getListCardRadius(getListCardPosition(index, sectionMeta.length)),
                textAlign: 'left',
  ...
  const currentSection = sectionMeta.find((item) => item.key === selectedSection)
        ...
        {selectedSection === 'appearance' && (
          ...
          >
            <Stack spacing={3}>
              ...
              >
                <Typography variant="subtitle1" sx={{ mb: 2, fontWeight: 650 }}>
                  {t('settings.appearanceThemeGroup')}
                </Typography>
                ...
                >
                  {ACCENT_COLOR_OPTIONS.map((option) => {
                    ...
                    return (
                      <Tooltip
                        key={option.id}
                        title={t(`settings.accentColorOptions.${option.id}`)}
                        arrow
                      >
                        <ButtonBase
                          component="button"
                          ...
                          sx={{
                            ...
                            bgcolor: selected
                              ? withThemeAlpha(theme, option.value, 0.12)
                              : 'transparent',
              ...
              >
                <Typography variant="subtitle1" sx={{ mb: 2, fontWeight: 650 }}>
                  {t('settings.appearanceCardsGroup')}
                </Typography>
                <Typography variant="subtitle2" sx={{ mb: 1.25 }}>
              ...
              >
                <Typography variant="subtitle1" sx={{ mb: 2, fontWeight: 650 }}>
                  {t('settings.appearanceNotificationsGroup')}
                </Typography>
                <SettingsSwitchCard
                ...
                <TextField
                  ...
                  onChange={(event) =>
                    void handleToastPositionChange(event.target.value as ToastPosition)
                  }
                  sx={{ mt: 1.5 }}
                >
                  ...
                  <MenuItem value="bottom-center">
                    {t('settings.toastPositionBottomCenter')}
                  </MenuItem>
              ...
              >
                <Typography variant="subtitle1" sx={{ mb: 2, fontWeight: 650 }}>
                  {t('settings.appearanceLanguageGroup')}
                </Typography>
                <TextField
                  select
          ...
          >
            <Stack spacing={3}>
                  ...
                  <Box>
                    ...
                    >
                      <Typography variant="subtitle2">
                        {t('settings.checkAllConcurrency')}
                      </Typography>
                      <Typography
                        variant="body2"
                        sx={{
              ...
              <Box>
                ...
                >
                  <Typography variant="subtitle2">
                    {t('settings.domainCheckConcurrency')}
                  </Typography>
                  <Typography
                    variant="body2"
                    sx={{
