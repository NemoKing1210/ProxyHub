export const SYNC_GIST_FILENAME = 'proxychecker-sync.pcbackup.json' as const

export const SYNC_GIST_DESCRIPTION = 'ProxyChecker sync data' as const
...
export const GITHUB_CREATE_TOKEN_URL =
  'https://github.com/settings/tokens/new?scopes=gist&description=ProxyChecker%20Sync'
